...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function initMinTempLayer(url = 't_min_2021_01') {
        minTLayer = L.vectorGrid.protobuf(
            `https://tileservergl-proxy.vercel.app:10000/tiles/data/${url}/{z}/{x}/{y}.pbf`, {
    ...
    const regionsLayer = L.vectorGrid.protobuf(
        'https://tileservergl-proxy.vercel.app:10000/tiles/data/regions/{z}/{x}/{y}.pbf', {
        rendererFactory: L.canvas.tile,
        interactive: true,
        pane: 'regions',
        attribution: '© My Data',
    ...
    const countriesLayer = L.vectorGrid.protobuf(
        'https://tileservergl-proxy.vercel.app:10000/tiles/data/countries/{z}/{x}/{y}.pbf', {
        rendererFactory: L.canvas.tile,
        interactive: true,
        pane: 'countries',
        attribution: '© My Data',
